...
import { tether, playerTurn, warning, playing } from './variables';

// Função que marca a jogada...
export const handleTheterItemClick = (event) => {
...
export const handleRenderInfos = () => {
...
export const handleTogglePlayer = () => {
...
export const handleRenderTether = () => {
